...
* \\(\langle d_1,\ldots,d_n\rangle\rho^\ast_F 1\\) holds iff \\(\langle d_1,\ldots,d_n\rangle\rho\_F 0\\) doesn't hold.
* \\(\langle d_1,\ldots,d_n\rangle\rho^\ast_F 0\\) holds iff \\(\langle d_1,\ldots,d_n\rangle\rho\_F 1\\) doesn't hold.
